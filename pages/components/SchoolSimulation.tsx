...
const SchoolSimulation: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch('https://viz-project-3.netlify.app/.netlify/functions/school-simulation'); // Adjust this URL to your Netlify function URL if needed
